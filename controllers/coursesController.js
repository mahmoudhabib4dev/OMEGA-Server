...
const { REQUIRED_FIELDS_MESSING, MISSING_FIELDS, ROLE_ERROR, MISSING_ID, SERVER_ERROR, USER_NOT_FOUND, YOU_ARE_NOT_AUTHORIZED } = require('../configs/messages.js');
...
const createCourse = async (req, res) => {
    ...
    try {
        ...
        const createCourseResult = await client.query(`INSERT INTO courses (created_by , teacher_id , title , description , cover_image_url) VALUES ($1, $2, $3, $4, $5)`);
    } catch (error) {
